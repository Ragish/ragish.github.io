...
$(document).ready(function () {
    ...
    e.fullWidth = function () {
        $(window).load(function () {
            t.isotope({ animationEngine: "best-available", animationOptions: { duration: 250, easing: "easeInOutSine", queue: false } });
        });
...
$(function () {
    $(".nav li a").bind("click", function (e) {
        ...
        $("html, body")
            .stop()
            .animate({ scrollTop: $(t.attr("href")).offset().top - 70 }, 2e3, "easeInOutExpo");
        e.preventDefault();
    });
});
$(function () {
...
$(function () {
    $("#fullscreen-slider").maximage({
        cycleOptions: { fx: "fade", speed: 1e3, timeout: 5e3, pause: 1 },
...
var mySwiper = new Swiper(".swiper-testimonial", { mode: "horizontal", loop: true, speed: 400, autoplay: 5e3, autoResize: true, pagination: ".pagination-testimonial", paginationClickable: true });
var auto_slide = 1;
var hover_pause = 1;
var key_slide = 1;
